...
public interface IShellUIHelper4 : IShellUIHelper3
{
	...
	[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
	[DispId(44)]
	void msSiteModeSetIconOverlay([In][MarshalAs(UnmanagedType.BStr)] string IconUrl, [Optional][In][MarshalAs(UnmanagedType.Struct)] ref object pvarDescription);
	...
	[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
	[DispId(52)]
	void msSiteModeAddJumpListItem([In][MarshalAs(UnmanagedType.BStr)] string bstrName, [In][MarshalAs(UnmanagedType.BStr)] string bstrActionUri, [In][MarshalAs(UnmanagedType.BStr)] string bstrIconUri, [Optional][In][MarshalAs(UnmanagedType.Struct)] ref object pvarWindowType);
